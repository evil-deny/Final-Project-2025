...
本專題希望同學能透過實作以下幾個編碼方法，驗證各階段影像處理與壓縮技術之正確性：

1. 熟悉 BMP 影像格式與 pixel 排列方式  
2. 理解 JPEG-like 壓縮流程（DCT、Quantization、RLE、Huffman）  
3. 比較 ASCII 與 Binary 儲存格式的差異  
4. 建立可重現、可自動化測試的影像編碼系統  
